...
OUTPUT_DIR="${OUTPUT_DIR:-baseline/caa_pyvene_0/artifacts/vectors/${MODEL_NAME}/${TASK}/${RUN_NAME}}"
RUN_DIR="baseline/caa_pyvene_0/runs/train/${MODEL_NAME}/${TASK}/${RUN_NAME}/${RUN_TS}"
...
DEVICE="${DEVICE}" \
TORCH_DTYPE="${TORCH_DTYPE}" \
bash baseline/caa_pyvene_0/train_caa_vector.sh

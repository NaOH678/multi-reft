...
OUTPUT_DIR="${OUTPUT_DIR:-baseline/iti_0/artifacts/interventions/${MODEL_NAME}/${TASK}/${RUN_NAME}}"
RUN_DIR="baseline/iti_0/runs/train/${MODEL_NAME}/${TASK}/${RUN_NAME}/${RUN_TS}"
...
MAX_ITER="${MAX_ITER}" \
KEEP_FEATURE_CACHE="${KEEP_FEATURE_CACHE}" \
bash baseline/iti_0/train_iti_intervention.sh

...
CAA_ROOT = PROJECT_ROOT / "baseline/CAA_0"
ARTIFACT_ROOT = CAA_ROOT / "artifacts"
RUN_ROOT = CAA_ROOT / "runs"
VECTOR_ROOT = ARTIFACT_ROOT / "vectors"
...
DEFAULT_SINGLE_LAYER_TASKS = {"bias", "ethics", "toxicity"}
...
def get_task_input_mode(task: str) -> str:
    ...
    return TASK_INPUT_MODES[normalized]


def get_task_schema_type(task: str) -> str:
    normalized = normalize_task_name(task)
    return TASK_SCHEMA_TYPES[normalized]

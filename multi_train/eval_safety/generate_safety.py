...
def generate_prompt(instruction, input=None):
    prompt_no_input_template = """<safety> Below is an instruction that \
...
def main():
    ...
    dataset = load_from_disk('multi_train/eval_safety/data')['train']
    total = len(dataset)
    ...
    output_dir = "./multi_train/eval_safety"

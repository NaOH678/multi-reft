...
OUTPUT_JSON="${OUTPUT_JSON:-${STATS_DIR}/residual_stats_specialist_train_input.json}"
...
echo "Building specialist-specific residual stats..."
...
echo "Specialist residual stats saved to: ${OUTPUT_JSON}"

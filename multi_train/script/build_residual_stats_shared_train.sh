...
OUTPUT_JSON="${OUTPUT_JSON:-${STATS_DIR}/residual_stats_shared_train_input.json}"
...
echo "Building shared residual stats..."
...
echo "Shared residual stats saved to: ${OUTPUT_JSON}"

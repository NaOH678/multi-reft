...
OUTPUT_JSON="${OUTPUT_JSON:-${STATS_DIR}/intervention_stats_shared_train_input.json}"
...
echo "Building shared intervention stats..."
...
echo "Shared intervention stats saved to: ${OUTPUT_JSON}"

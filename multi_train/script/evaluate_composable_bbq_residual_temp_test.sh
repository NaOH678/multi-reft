...
# run_exp "E3_residual_output_tmp1" "${GPU_IDS_ARR[0]}" \
#   --positions 7 \
#   --compose_domain output \
#   --composition_method residual_softmax \
#   --composition_temperature 1.0 &

# run_exp "E3_residual_output_tmp2" "${GPU_IDS_ARR[1]}" \
#   --positions 7 \
#   --compose_domain output \
#   --composition_method residual_softmax \
#   --composition_temperature 2.0 &

run_exp "E3_residual_output_tmp18" "${GPU_IDS_ARR[0]}" \
  --positions 7 \
  --compose_domain output \
  --composition_method residual_softmax \
  --composition_temperature 18 &

run_exp "E3_residual_output_tmp20" "${GPU_IDS_ARR[1]}" \
  --positions 7 \
  --compose_domain output \
  --composition_method residual_softmax \
  --composition_temperature 20 &

run_exp "E3_residual_output_tmp24" "${GPU_IDS_ARR[2]}" \
  --positions 7 \
  --compose_domain output \
  --composition_method residual_softmax \
  --composition_temperature 24 &

run_exp "E3_residual_output_tmp32" "${GPU_IDS_ARR[3]}" \
  --positions 7 \
  --compose_domain output \
  --composition_method residual_softmax \
  --composition_temperature 32 &

run_exp "E3_residual_output_tmp64" "${GPU_IDS_ARR[4]}" \
  --positions 7 \
  --compose_domain output \
  --composition_method residual_softmax \
  --composition_temperature 64 &

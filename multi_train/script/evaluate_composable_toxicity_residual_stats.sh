...
LOG_DIR="${LOG_DIR:-multi_train/logs/composable_toxicity_residual_stats_$(date +%Y%m%d_%H%M%S)}"
mkdir -p "${LOG_DIR}"
...
echo "All composable toxicity residual-stats experiments finished."
